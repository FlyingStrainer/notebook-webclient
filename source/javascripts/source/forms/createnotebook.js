...
export default class NewNotebookForm extends React.Component {
	constructor(props) {
		super(props);
		this.state = {};
	...
	render() {
		return <NotebookFields dataEntry={this.dataEntry}/>;
	}
}

class NotebookFields extends React.Component {
	constructor(props) {
		super(props);
